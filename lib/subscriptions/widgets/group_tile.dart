...
import 'package:quax/subscriptions/_group_list_item.dart' show groupFallbackColor;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Flexible(
                    child: LayoutBuilder(
                      builder: (context, constraints) => AvatarMosaic(
                        // Never larger than the space actually left after the
                        // text, so a 2x font scale shrinks the mosaic instead
                        // of overflowing the tile.
                        extent: constraints.biggest.shortestSide.clamp(0.0, 74.0),
