...
Future<String> followGroupAddCandidate(BuildContext context, GroupAddCandidate candidate) async {
  switch (candidate.source) {
    ...
    case GroupAddSource.threads:
      ...
      await context.read<ThreadsAccountsStore>().add(ThreadsAccount(handle: candidate.value, name: candidate.value));
    ...
    case GroupAddSource.bluesky:
      return _followBluesky(context.read<BlueskyClient>(), context.read<BlueskyAccountsStore>(), candidate.value);
...
Future<String> _followBluesky(BlueskyClient client, BlueskyAccountsStore accounts, String actor) async {
