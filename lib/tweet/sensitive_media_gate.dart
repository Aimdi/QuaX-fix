...
class SensitiveMediaGate extends StatelessWidget {
  ...
  const SensitiveMediaGate({super.key, this.sensitive = true, this.errorMessage, this.child, this.wrapInCard = true});
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<TweetContextState>(
      builder: (context, model, _) {
        if (!sensitive || !model.hideSensitive) {
          return content;
        }
  ...
  Widget _gate(BuildContext context, BasePrefService prefs, {TweetContextState? model}) {
    ...
    final body = Padding(
      ...
      child: Column(
        ...
        children: [
          Text(l10n.possibly_sensitive, textAlign: TextAlign.center, style: const TextStyle(fontSize: 18)),
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              ElevatedButton(onPressed: () => state.setHideSensitive(false), child: Text(l10n.sensitive_media_show)),
              TextButton(
